...
defineProps<{
  ...
  showSkeletonLayerB: boolean
  showSemanticLayerC: boolean
  showLayer4: boolean
  showLayer5: boolean
  showLayer6: boolean
  showLayer7: boolean
...
const emit = defineEmits<{
  ...
  toggleSkeletonLayerB: [value: boolean]
  toggleSemanticLayerC: [value: boolean]
