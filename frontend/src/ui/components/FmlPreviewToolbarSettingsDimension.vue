...
import { FML_FIELD_COMMIT_DEBOUNCE_MS } from '@/ui/composables/fml-preview/fml-preview-draft-commit'
...
<template>
  <span class="fml-toolbelt__meta">{{ t('result.toolbar.dimensionSelected') }}</span>
  <div class="fml-toolbelt__field">
    <span class="fml-toolbelt__field-label">{{ t('result.toolbar.dimensionLength') }}</span>
