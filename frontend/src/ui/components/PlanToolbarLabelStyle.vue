...
import { clampLabelFontSize } from '@/ui/composables/plan-canvas/plan-canvas-render-annotations'
...
<template>
  <div class="plan-toolbelt__field">
    <span class="plan-toolbelt__field-label">{{ t('result.toolbar.labelSize') }}</span>
  ...
  <div class="plan-toolbelt__field">
    <span class="plan-toolbelt__field-label">{{ t('result.toolbar.labelColor') }}</span>
    <div class="plan-toolbelt__field-controls">
      <HexColorField v-model="fontColor" :aria-label="t('result.toolbar.labelColor')" />
    </div>
  </div>
  <div class="plan-toolbelt__field">
    <span class="plan-toolbelt__field-label">{{ t('result.toolbar.labelStyle') }}</span>
    <div class="plan-toolbelt__field-controls">
      <button
        type="button"
