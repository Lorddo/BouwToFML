...
<template>
  <div class="fml-toolbelt-stack">
    <div class="fml-toolbelt__row fml-toolbelt__row--primary">
      <span class="fml-toolbelt__meta">{{ panel.name }}</span>
      <span class="fml-toolbelt__meta">{{ wallCountLabel }} · {{ floorCountLabel }}</span>
      <div class="fml-toolbelt__field" :title="t('result.toolbar.facadeGroupThicknessHint')">
