...
import type { ItemResizeSide } from '@/ui/composables/fml-preview/item-resize-handles'
import type { ItemRotateCorner } from '@/ui/composables/fml-preview/item-rotate-handles'
