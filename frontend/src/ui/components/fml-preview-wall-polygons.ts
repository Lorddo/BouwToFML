...
import { resolveWallExtents } from '@/ui/components/fml-preview-wall-fill'
...
} from '@/ui/components/fml-preview-wall-fill'

export { buildWallOutlinePolylines } from '@/ui/components/fml-preview-wall-outline'
