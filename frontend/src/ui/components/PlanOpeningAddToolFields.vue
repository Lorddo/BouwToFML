...
<template>
  <div v-if="activeTool === 'add_door'" class="plan-toolbelt__field">
    <span class="plan-toolbelt__field-label">{{ t('result.toolbar.doorType') }}</span>
  ...
  <div v-if="activeTool === 'add_door'" class="plan-toolbelt__field">
    <span class="plan-toolbelt__field-label">{{ t('result.toolbar.size') }}</span>
    <div class="plan-toolbelt__field-controls">
      <ScaleLengthInput
        :cm="addDoorWidthCm"
        :unit="unit"
  ...
  <div v-if="activeTool === 'add_window'" class="plan-toolbelt__field">
    <span class="plan-toolbelt__field-label">{{ t('result.toolbar.windowType') }}</span>
    <div class="plan-toolbelt__field-controls">
      <select
  ...
  <div v-if="activeTool === 'add_window'" class="plan-toolbelt__field">
    <span class="plan-toolbelt__field-label">{{ t('result.toolbar.glass') }}</span>
    <div class="plan-toolbelt__field-controls">
      <ScaleLengthInput
