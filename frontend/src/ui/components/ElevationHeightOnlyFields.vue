...
<template>
  <span class="plan-toolbelt__meta">{{ title }}</span>
  <div v-if="showBottomZ" class="plan-toolbelt__field">
  ...
  <div class="plan-toolbelt__field">
    <span class="plan-toolbelt__field-label">{{ t('result.toolbar.height') }}</span>
    <div class="plan-toolbelt__field-controls">
      <ScaleLengthInput
        :cm="heightCm"
        :unit="unit"
