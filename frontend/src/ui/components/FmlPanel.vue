 ...
 *
 * F (half-steen): `importedFmlText` / `importedStats` / `importedWarnings` + emit
 * `clearImport` are wired from WorkspaceView but not rendered here yet. Keep until
 * import-stats UI is built; do not knip from View in this round.
 *
