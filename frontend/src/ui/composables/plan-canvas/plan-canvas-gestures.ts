...
export const PLAN_CANVAS_CHROME_SELECTOR =
  '.plan-canvas-hint, .canvas-toolbelt-dock, .canvas-toolbelt, .fixture-palette, .fixture-palette-dock, .editor-topbar, .editor-help-modal, .plan-chrome-dialog, .editor-mod-rail, .item-settings, .elev-groups, button, input, label, select'
