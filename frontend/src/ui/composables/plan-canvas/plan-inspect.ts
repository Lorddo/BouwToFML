export type InspectKind = 'wall' | 'door' | 'window' | 'area' | 'surface' | 'item'
...
export function inspectKindLabel(kind: InspectKind): string {
 ...
 *
 * F (bewust): edit-pick in `usePlanCanvasPointer` heeft een andere volgorde
