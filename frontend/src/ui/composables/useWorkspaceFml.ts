...
export function useWorkspaceFml(deps: {
  ...
  return {
    ...
    previewPlan: generate.previewPlan,
    previewUnderlayLayout: generate.previewUnderlayLayout,
    fmlNulpuntImageCm: generate.fmlNulpuntImageCm,
    fmlOrient: generate.fmlOrient,
    ...
    setFmlNulpuntImageCm: generate.setFmlNulpuntImageCm,
    setFmlOrient: generate.setFmlOrient,
