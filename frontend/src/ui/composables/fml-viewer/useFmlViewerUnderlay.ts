...
import { scaleFloorPlanAndRegenAreas } from '@/ui/composables/fml-preview/regenerate-floor-areas'
import {
...
export interface UseFmlViewerUnderlayOptions {
 ...
 */
export function useFmlViewerUnderlay(options: UseFmlViewerUnderlayOptions) {
  const {
    plan,
    activeFloorIndex,
    activeFloor,
