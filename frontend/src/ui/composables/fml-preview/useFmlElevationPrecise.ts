...
} from './fml-elevation-precise-move'
import { resolveRelocatePointerIntent } from './fml-preview-mods'
import type { ElevationInteractionProps } from './fml-elevation-interaction-types'
...
export interface UseFmlElevationPreciseOptions {
...
export function useFmlElevationPrecise(options: UseFmlElevationPreciseOptions) {
  const {
    props,
    elevation,
    clientToCm,
