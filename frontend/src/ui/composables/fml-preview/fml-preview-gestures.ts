...
export const FML_PREVIEW_CHROME_SELECTOR =
  '.fml-preview-hint, .canvas-toolbelt-dock, .canvas-toolbelt, .fixture-palette, .fixture-palette-dock, .fml-editor-topbar, .fml-help-modal, .fml-chrome-dialog, .fml-mod-rail, .item-settings, .elev-groups, button, input, label, select'
