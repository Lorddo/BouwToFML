...
import { setPlanWallsThicknessKeepBalance } from '@/ui/components/fml-preview-wall-edit'
...
export interface FmlEditorFacadeStampDeps {
...
export function createFmlEditorFacadeStamp(deps: FmlEditorFacadeStampDeps) {
