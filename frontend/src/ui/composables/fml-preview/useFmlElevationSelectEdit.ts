...
import { buildElevationOpeningMeasureLines } from './fml-preview-elevation-opening-measure'
import {
...
export function useFmlElevationSelectEdit(options: {
...
export type FmlElevationSelectEdit = ReturnType<typeof useFmlElevationSelectEdit>
