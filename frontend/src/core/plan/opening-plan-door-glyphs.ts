...
import { resolveHingeAtStart, resolveSwingSign } from './door-swing-symbol'
import {
  BIFOLD_EDGE_GAP_CM,
...
export function buildDoorKindGlyphs(params: BuildDoorPlanSymbolInput): OpeningPlanSymbol {
  switch (params.kind) {
    case 'double_wide':
      return {
