...
function runSanitizePass(walls: Wall[]): SanitizePlanWallsResult {
...
export function sanitizePlanWallsDetailed(walls: Wall[]): SanitizePlanWallsResult {
...
export function sanitizePlanWalls(walls: Wall[]): Wall[] {
  return sanitizePlanWallsDetailed(walls).walls
}
