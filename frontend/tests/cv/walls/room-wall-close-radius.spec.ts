...
describe('resolveMergedWallCloseRadiusPx', () => {
  ...
  it('schaalt open walls mee met referentiedikte', () => {
    ...
    expect(resolveMergedWallCloseRadiusPx({ wallStyle: 'open', referenceWallThicknessPx: 30 })).toBe(1)
  ...
  it('houdt solid walls conservatief bij referentiedikte', () => {
    ...
    expect(resolveMergedWallCloseRadiusPx({ wallStyle: 'solid', referenceWallThicknessPx: 30 })).toBe(1)
  ...
  it('clamped op veilige maxima voor extreme dikte', () => {
    ...
    expect(resolveMergedWallCloseRadiusPx({ wallStyle: 'open', referenceWallThicknessPx: 200 })).toBe(5)

    expect(resolveMergedWallCloseRadiusPx({ wallStyle: 'solid', referenceWallThicknessPx: 200 })).toBe(5)
