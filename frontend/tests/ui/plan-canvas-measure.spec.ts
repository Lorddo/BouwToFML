...
describe('plan-canvas-measure', () => {
  ...
  it('formatteert in de liniaal-eenheid', () => {
    expect(formatMeasureDistanceCm(45.3, 'cm')).toBe('45.3 cm')
    expect(formatMeasureDistanceCm(250, 'm')).toBe('2.5 m')
    expect(formatMeasureDistanceCm(250, 'mm')).toBe('2500 mm')
  })
