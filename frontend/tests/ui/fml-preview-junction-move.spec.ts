...
import { useFmlPreviewJunctionMove } from '@/ui/composables/fml-preview/useFmlPreviewJunctionMove'
import type { RenderJunction } from '@/ui/composables/fml-preview/fml-preview-render-types'
...
describe('useFmlPreviewJunctionMove typed distance', () => {
  it('commits a 0.4 cm typed move in centimetres', () => {
    ...
    scope.run(() => {
      ...
      const walls = [wall('w1')]
      const move = useFmlPreviewJunctionMove({
