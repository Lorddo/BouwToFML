...
import { measureDistanceCm } from '@/ui/composables/fml-preview/fml-preview-measure'
import {
  buildWallInternalMeasureLines,
  buildWallsInternalMeasureLines,
  wallIdsForJunctionMove,
  wallIdsForSegmentMove,
} from '@/ui/composables/fml-preview/fml-preview-wall-internal-measure'
...
describe('fml-preview-wall-internal-measure', () => {
