...
import { slideOpeningAlongWall } from '@/ui/components/fml-preview-opening-drag-geom'
import { useFmlPreviewOpeningMove } from '@/ui/composables/fml-preview/useFmlPreviewOpeningMove'
...
describe('useFmlPreviewOpeningMove typed distance', () => {
  it('commits a typed slide along the wall axis', () => {
    ...
    scope.run(() => {
      ...
      const move = useFmlPreviewOpeningMove({
