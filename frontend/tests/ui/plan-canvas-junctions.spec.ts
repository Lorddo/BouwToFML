    ...
    const walls = [
      {
        ...
        thickness: 20,
        openings: [
          { id: 'door', kind: 'door.single' as const, t: 0.3, width: 10, type: 'door' as const },
          { id: 'window', kind: 'window.single' as const, t: 0.7, width: 12, type: 'window' as const },
        ],
      },
    ]
    ...
    const walls = [
      {
        ...
        b: { x: 100, y: 0 },
        thickness: 20,
        openings: [{ id: 'door', kind: 'door.single' as const, t: 0.4, width: 10, type: 'door' as const }],
      },
      {
        id: 'w2',
        a: { x: 0, y: 0 },
        b: { x: 0, y: 80 },
        thickness: 20,
        openings: [{ id: 'window', kind: 'window.single' as const, t: 0.5, width: 10, type: 'window' as const }],
      },
    ]
    ...
    const walls = [
      {
        ...
        thickness: 20,
        openings: [
          { id: 'door-a', kind: 'door.single' as const, t: 0.25, width: 90, type: 'door' as const },
          { id: 'door-b', kind: 'door.single' as const, t: 0.75, width: 90, type: 'door' as const },
        ],
      },
    ]
    const result = splitWallAtMidpoint(walls, 'w1')!
    ...
    const walls = [
      {
        ...
        thickness: 20,
        openings: [
          { id: 'door', kind: 'door.single' as const, t: 0.2, width: 10, type: 'door' as const },
          { id: 'window', kind: 'window.single' as const, t: 0.8, width: 12, type: 'window' as const },
        ],
      },
    ]
    ...
    const walls = [
      {
        ...
        thickness: 20,
        openings: [
          { id: 'o1', kind: 'door.single' as const, t: 0.2, width: 90, type: 'door' as const },
          { id: 'o2', kind: 'door.single' as const, t: 0.8, width: 90, type: 'door' as const },
        ],
      },
    ]
...
describe('addRoomRect', () => {
  it('reuses existing host edge and splits host wall at room corners', () => {
    const walls = [
      {
        ...
        b: { x: 100, y: 0 },
        thickness: 20,
        openings: [{ id: 'host-door', kind: 'door.single' as const, t: 0.8, width: 90, type: 'door' as const }],
      },
    ]
    ...
    const withDoor = result!.walls.filter((wall) =>
      wall.openings.some((opening) => opening.id === 'host-door'),
    )
  ...
  it('outwards met openingen op staying-muur: geen parallelle stub, wel connector', () => {
    const walls = [
      ...
      },
      {
        ...
        thickness: 20,
        openings: [
          { type: 'door' as const, id: 'd1', kind: 'door.single' as const, t: 0.25, width: 8 },
          { type: 'door' as const, id: 'd2', kind: 'door.single' as const, t: 0.5, width: 8 },
          { type: 'door' as const, id: 'd3', kind: 'door.single' as const, t: 0.75, width: 8 },
        ],
      },
      {
        id: 'wBranch',
    ...
    const walls = [
      {
        ...
        b: { x: 50, y: 0 },
        thickness: 20,
        openings: [{ id: 'door-left', kind: 'door.single' as const, t: 0.4, width: 10, type: 'door' as const }],
      },
      {
        id: 'wDrag',
        a: { x: 50, y: 0 },
        b: { x: 100, y: 0 },
        thickness: 20,
        openings: [{ id: 'door-drag', kind: 'door.single' as const, t: 0.5, width: 10, type: 'door' as const }],
      },
    ]
  ...
  it('L-hoek slide: opening op stilstaande been houdt wereldpositie', () => {
    const walls = [
      ...
      },
      {
        ...
        b: { x: 50, y: 80 },
        thickness: 20,
        openings: [{ id: 'win', kind: 'window.single' as const, t: 0.5, width: 10, type: 'window' as const }],
      },
    ]
