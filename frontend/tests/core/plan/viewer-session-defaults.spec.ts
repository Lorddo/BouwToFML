...
import { seedViewerDefaultsFromPlan } from '@/core/plan/viewer-session-defaults'
          ...
          walls: [
            {
              ...
              thickness: 20,
              openings: [
                { type: 'door', id: 'd1', kind: 'door.single', t: 0.3, width: 90, z_height: 220 },
                { type: 'door', id: 'd2', kind: 'door.single', t: 0.7, width: 90, z_height: 220 },
                {
                  type: 'window',
                  id: 'w',
                  kind: 'window.single',
          ...
          walls: [
            {
              ...
              b: { x: 10, y: 0 },
              thickness: 20,
              openings: [{ type: 'door', id: 'd', kind: 'door.single', t: 0.5, width: 90, z_height: 200 }],
            },
          ],
        },
        {
          ...
          walls: [
            {
              ...
              b: { x: 10, y: 0 },
              thickness: 20,
              openings: [{ type: 'door', id: 'd', kind: 'door.single', t: 0.5, width: 90, z_height: 230 }],
            },
          ],
        },
      ],
