...
import { bindFloorWallsToRoofs, sampleCeilingRoofAtPoint } from '@/core/plan/bind-walls-to-roofs'
import { createEmptyFloorPlan } from '@/core/plan/empty-floor-plan'
import { projectFacadeElevation } from '@/core/plan/facade-elevation'
import { createFacadeGroup, assignWallsToGroup } from '@/core/plan/facade-groups'
import {
  clampLiningCm,
...
} from '@/core/plan/roof-clear-height'
